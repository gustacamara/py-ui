...
detour_controller = Blueprint('detour_blueprint', __name__, template_folder="templates") 
...
def try_remove_detour():
    ...
    if request.method == 'POST':
        ...
        data = utils.json_util.import_json(detour_blueprint.root_path + '/database/actuators.json')
        # print("\n\n\n\n\n\n\n\n\n\nSensor a ser removido:", sensor_id)
        name = data.pop(int(detour_id))
        utils.json_util.export_json(detour_blueprint.root_path + '/database/actuators.json', data)
...
def edit_detour(error = False):
    ...
    if request.method == 'POST':
        ...
        data = utils.json_util.import_json(detour_blueprint.root_path + '/database/actuators.json')[int(edit_id)]
